...
xuanren::~xuanren()
{
    ...
    CCTextureCache::sharedTextureCache()->removeTextureForKey("xuanren_bg.png");
    CCTextureCache::sharedTextureCache()->removeTextureForKey("enterview.png");
    CCTextureCache::sharedTextureCache()->removeTextureForKey("zg_big_01.png");
    CCTextureCache::sharedTextureCache()->removeTextureForKey("zg_big_02.png");
    CCTextureCache::sharedTextureCache()->removeTextureForKey("zg_big_03.png");
}
